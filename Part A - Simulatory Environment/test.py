...
try:
    ...
    # Note: Numba requires external installation and cannot run in this environment.
    import numba as nb
...
def update_one_unit_time():
    ...
    print(f"WEEK {int(time1)} ({current_year}-{current_week:02d}) | Agents: {current_fish_count_for_print+len(fishermen)} | Biomass: {total_biomass:.2f} kg | Catch: {current_step_catch:.2f} kg")
